...
/**
 * @deprecated Use `formatISO` or `formatRFC3339` from `date-fns` instead.
 *             Since version 3.0 date-fns is tree shakeable.
 * @see https://tc39.es/proposal-temporal/docs/ For the Temporal proposal
 * @see https://date-fns.org/v3.6.0/docs/formatISO
 */
